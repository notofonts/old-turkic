...
<p>Your font does <em>not</em> cover the following languages that require the soft-dotted feature: Ukrainian (Cyrl, 29,273,587 speakers), Ejagham (Latn, 120,000 speakers), Mango (Latn, 77,000 speakers), Dan (Latn, 1,099,244 speakers), Vute (Latn, 21,000 speakers), Sar (Latn, 500,000 speakers), Kpelle, Guinea (Latn, 622,000 speakers), Igbo (Latn, 27,823,640 speakers), Ma’di (Latn, 584,000 speakers), Bete-Bendi (Latn, 100,000 speakers), Belarusian (Cyrl, 10,064,517 speakers), Ngbaka (Latn, 1,020,000 speakers), Avokaya (Latn, 100,000 speakers), Koonzime (Latn, 40,000 speakers), Mundani (Latn, 34,000 speakers), Lugbara (Latn, 2,200,000 speakers), Navajo (Latn, 166,319 speakers), Zapotec (Latn, 490,000 speakers), Ekpeye (Latn, 226,000 speakers), Ijo, Southeast (Latn, 2,471,000 speakers), Bafut (Latn, 158,146 speakers), Mfumte (Latn, 79,000 speakers), Aghem (Latn, 38,843 speakers), Yala (Latn, 200,000 speakers), Makaa (Latn, 221,000 speakers), Dii (Latn, 71,000 speakers), Cicipu (Latn, 44,000 speakers), Southern Kisi (Latn, 360,000 speakers), Gulay (Latn, 250,478 speakers), South Central Banda (Latn, 244,000 speakers), Nzakara (Latn, 50,000 speakers), Ebira (Latn, 2,200,000 speakers), Basaa (Latn, 332,940 speakers), Fur (Latn, 1,230,163 speakers), Nateni (Latn, 100,000 speakers), Kom (Latn, 360,685 speakers).</p>
 [code: soft-dotted]
...
<li>U+0307 COMBINING DOT ABOVE: try adding one of: syriac, math, malayalam, tifinagh, canadian-aboriginal, tai-le, coptic, old-permic</li>
...
<li>U+200D ZERO WIDTH JOINER: try adding one of: nko, grantha, tagbanwa, gurmukhi, warang-citi, mahajani, bhaiksuki, kaithi, new-tai-lue, tibetan, devanagari, limbu, sinhala, khmer, khudawadi, tai-tham, kayah-li, phags-pa, tai-viet, duployan, hebrew, gujarati, avestan, kharoshthi, mongolian, siddham, syloti-nagri, tagalog, rejang, sharada, dogra, chakma, hanifi-rohingya, cham, batak, psalter-pahlavi, newa, meetei-mayek, bengali, buginese, pahawh-hmong, thaana, tamil, saurashtra, yi, lepcha, manichaean, thai, myanmar, old-hungarian, syriac, takri, hanunoo, masaram-gondi, mandaic, arabic, buhid, zanabazar-square, brahmi, telugu, malayalam, gunjala-gondi, modi, oriya, kannada, lao, khojki, sogdian, tifinagh, tai-le, tirhuta, sundanese, balinese, javanese</li>
</ul>
